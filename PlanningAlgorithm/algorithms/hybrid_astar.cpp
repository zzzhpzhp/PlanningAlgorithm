...
namespace algorithm
{
    void HybirdAstar::initialize(environment::EnvironmentInterfacePtr &env, std::string name)
    {
        env_ptr_ = env;
        name_ = name;

        side_points_.emplace_back(boost::bind(&HybirdAstar::_get_right, this, _1, _2, _3, _4, _5, 1));
        side_points_.emplace_back(boost::bind(&HybirdAstar::_get_middle_higher, this, _1, _2, _3, _4, _5, 1));
        side_points_.emplace_back(boost::bind(&HybirdAstar::_get_left, this, _1, _2, _3, _4, _5, 1));
        side_points_.emplace_back(boost::bind(&HybirdAstar::_get_middle_lower, this, _1, _2, _3, _4, _5, 1));

        side_points_.emplace_back(boost::bind(&HybirdAstar::_get_higher_right, this, _1, _2, _3, _4, _5, 1));
        side_points_.emplace_back(boost::bind(&HybirdAstar::_get_higher_left, this, _1, _2, _3, _4, _5, 1));
        side_points_.emplace_back(boost::bind(&HybirdAstar::_get_lower_left, this, _1, _2, _3, _4, _5, 1));
        side_points_.emplace_back(boost::bind(&HybirdAstar::_get_lower_right, this, _1, _2, _3, _4, _5, 1));
    ...
    environment::Path &HybirdAstar::getPath()
    {
        return path_;
    }
}
...
namespace algorithm
{
    ...
    HybirdAstar::getForwardLeftPose(double x, double y)
    {
        double cx, cy;
        return std::tie(cx, cy);
    }

    std::tuple<double, double>
    HybirdAstar::getForwardRightPose(double x, double y)
    {
        double cx, cy;
        return std::tie(cx, cy);
    }
